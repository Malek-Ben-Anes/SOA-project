    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Participation Form:</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('participation.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a href="http://localhost/flanci-preparation/public/get-all-challenges-freelancer-participated-in" class="btn btn-default">back</a>
                            </div>
                        </div>
                    </form>
                </div>
