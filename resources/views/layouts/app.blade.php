                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li  class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" onclick="messages()">
                            <p>{{  Auth::user()->message_list }} Messages<b class="caret"></b></p>
                        </a>
                         <ul class="dropdown-menu">
                        <li id="message-view-more" onclick="notifications()"><a>view more</a> </button></li>
                    </ul>
                    </li>
                    ...
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <p>{{  Auth::user()->notification_list }}  Notifications <b class="caret"></b></p>
                    </a>   
                    <ul class="dropdown-menu">
                        <li id="notification-view-more" onclick="notifications()"><a>view more</a> </button></li>
                    </ul>
                    </li>
                    <li class="dropdown">
